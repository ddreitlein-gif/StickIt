...
// v2.7.00 — the per-event CSV importer (POST /import-csv, processCsvRows,
// matchesDiscipline) was removed. Registration files are imported through the
// meet-level POST /api/meets/:id/registrations/import (server/import/registrationImport.js),
// with the event Registration tab passing event_id as a filter.
